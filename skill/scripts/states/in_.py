...
# Canonical wave-5 $65k Single gatekeeper lock. Hand-traced from IN
# DOR Form IT-40 — see module docstring. Referenced from test_state_in.py.
LOCK_VALUE: Final[Decimal] = Decimal("1920.00")
...
class IndianaPlugin:
    ...
    def apportion_income(
        ...
        return IncomeApportionment(
            state_source_wages=sourced_or_prorated_wages(return_, "IN", wages, days_in_state),
            ...
            state_source_self_employment=sourced_or_prorated_schedule_c(return_, "IN", se_net, days_in_state),
