...
class NebraskaPlugin:
    ...
    def apportion_income(
        ...
        return IncomeApportionment(
            state_source_wages=sourced_or_prorated_wages(return_, "NE", wages, days_in_state),
            ...
            state_source_self_employment=sourced_or_prorated_schedule_c(return_, "NE", se_net, days_in_state),
