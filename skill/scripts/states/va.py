...
class VirginiaPlugin:
    ...
    def render_pdfs(
        ...
        # TODO: fan-out follow-up — fill VA Form 760 (and Schedule ADJ,
        # if applicable) using pypdf against the Virginia Department of
        # Taxation's fillable PDF. The output renderer suite is the
